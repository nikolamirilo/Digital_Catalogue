...
const CardType4 = ({ record, currency }: { record: Record, currency: string }) => {
  return (
    <div className="flex flex-col !h-full bg-card-bg text-card-text rounded-[16px] border border-card-border shadow-[0_0_5px_1px_rgba(233,245,254,0.2)] w-[220px] sm:w-[260px] md:w-[320px] max-w-[90vw] flex-shrink-0">
