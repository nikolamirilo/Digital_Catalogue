...
const CardType3 = ({ record, currency }: { record: Record, currency: string }) => {
  return (
    <div className="bg-card-bg rounded-[12px] p-2 sm:p-4 text-card-text flex flex-col sm:flex-row border border-card-border shadow-[0_0_5px_1px_rgba(233,245,254,0.2)] gap-1.5 sm:gap-2 sm:items-center sm:justify-between">

  <div className="flex flex-col flex-1 gap-0.5 sm:gap-1">
    <h3 className="text-[14px] sm:text-[24px] font-normal text-card-heading font-lora leading-tight truncate">
      {record.name}
    </h3>
