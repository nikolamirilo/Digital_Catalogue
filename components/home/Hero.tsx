    ...
    return (
        ...
        >
            ...
            <div className="text-center">
                <h1 className="text-4xl md:text-6xl md:leading-tight font-bold text-product-foreground max-w-lg md:max-w-2xl mx-auto">{heroDetails.heading}</h1>
                <p className="mt-4 text-product-foreground max-w-lg mx-auto">{heroDetails.subheading}</p>
