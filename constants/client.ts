...
export const themes: Theme[] = [
    ...
    { key: "theme-organic", label: "Organic",  image: "/themes/dark_1.jpg", description: "A sophisticated and refined design for upscale dining experiences." },
  ...
  { key: "variant_4", label: "Layout 4", image: "/layouts/layout_4.jpg", description: "Layout with image used to emphasize importance of menu" },
];
